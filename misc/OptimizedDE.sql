...
-- 7. 10 branches whose real narrative entry is a check living in a
--    different branch entirely (a redundant 'Jump to: [flag]' system
--    node routes into them, re-testing a flag the jump already decided) -
--    see main.py's _BRANCH_TRUE_ENTRY for the full writeup. The local
--    system hub in each is untouched (still load-bearing for in-branch
--    looping) - this is metadata the frontend consults only on a cold
--    branch open or restart, not a graph edge.
CREATE TABLE branch_true_entry (conversationid INTEGER PRIMARY KEY, true_entry_conversationid INTEGER NOT NULL, true_entry_dialogueid INTEGER NOT NULL);
INSERT INTO branch_true_entry VALUES (616, 605, 198);
INSERT INTO branch_true_entry VALUES (1015, 1002, 358);
INSERT INTO branch_true_entry VALUES (1025, 1002, 29);
INSERT INTO branch_true_entry VALUES (1375, 1370, 534);
INSERT INTO branch_true_entry VALUES (1376, 1370, 536);
INSERT INTO branch_true_entry VALUES (1186, 995, 660);
INSERT INTO branch_true_entry VALUES (1371, 1370, 389);
INSERT INTO branch_true_entry VALUES (1373, 1370, 8);
INSERT INTO branch_true_entry VALUES (1374, 1370, 12);
INSERT INTO branch_true_entry VALUES (1377, 1370, 135);

-- 8. 401 precomputed welds reconnecting disconnected branch content
...
-- 9. FTS5 trigram search indexes over dialogue text and branch titles.
