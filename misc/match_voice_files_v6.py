"""match_voice_files_v6.py - v5 + a same-number/same-actor fallback tier.
...
Usage: python3 match_voice_files_v6.py <old.db> <jv.db> <sound.db>
"""
import re
import sqlite3
import sys
...
if __name__ == "__main__":
    ...
    import json
    with open("/tmp/v6_final_result.json", "w") as f:
        json.dump({str(k): v for k, v in final.items()}, f)
    print("wrote /tmp/v6_final_result.json")
